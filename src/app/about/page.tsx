    ...
    return (
        <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start mt-16">
                ...
                <div className="aspect-square bg-zinc-100 dark:bg-warm-900 border border-zinc-200 dark:border-warm-800 rounded-sm flex items-center justify-center p-6 md:p-12 transition-colors duration-300">
                    <div className="text-center">
                        <span className="text-zinc-900 dark:text-bodega-yellow font-display text-6xl md:text-8xl block mb-4 transition-colors duration-300">2AM</span>
