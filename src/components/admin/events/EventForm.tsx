...
export function EventForm({ onSubmit, isLoading, onCancel }: EventFormProps): React.ReactElement {
        ...
        <div className="space-y-2">
          ...
          {flyerPreview ? (
            ...
            <div
              ...
              className={cn(
                "w-full border-2 border-dashed rounded-sm p-8 text-center cursor-pointer transition-colors",
                dragOver
