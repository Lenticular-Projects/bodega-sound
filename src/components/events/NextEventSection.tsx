        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            >
              ...
              <h2 className="font-['Bebas_Neue'] text-7xl md:text-9xl text-zinc-900 dark:text-white tracking-tight leading-[0.8] mb-8 transition-colors duration-300 -ml-1 md:-ml-2">
                {nextEvent.name}
              </h2>
            </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            variants={fadeUp}
            className="relative group md:mt-10"
          >
